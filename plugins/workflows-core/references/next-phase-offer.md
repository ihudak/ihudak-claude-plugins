...
- `/product-workflows:brd-interview <BRD-KEY>` → `/product-workflows:brd-package <BRD-KEY>` (PM), offered
  ...
  `/product-workflows:brd-interview <BRD-KEY>` round (PM), or `/product-workflows:brd-ground <BRD-KEY>` (PA)
