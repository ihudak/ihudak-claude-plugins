...
description: Review OpenAPI specification files against REST API and IAM permission-naming guidelines. Checks version consistency, naming conventions, IAM scope format, HTTP status codes, and schema composition.
