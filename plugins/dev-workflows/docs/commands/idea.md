...
- *(Prior-art discovery over a personal vault was removed in 3.9.0 along with `$VAULT_PATH`. Prior art now means a PRD you hand the command yourself, as a path.)*
