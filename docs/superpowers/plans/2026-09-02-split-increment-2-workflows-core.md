...
**All of PS1–PS9 live in `workflows-core` except `ready.md`'s two instances of PS4, and every one is unblocked the moment this increment merges.** None waits on increments 3 or 4.
