...
Routing comes from `${CLAUDE_PLUGIN_ROOT}/references/model-routing/classification.md`, and the
handoff entry points from `${CLAUDE_PLUGIN_ROOT}/references/phase-handoff.md`.
