...
| Plugin | Description |
|--------|-------------|
| [dev-workflows](plugins/dev-workflows/) | Twenty-one slash commands for the PM → PA → PE → Dev pipeline, gated by Opus review at each phase. [Docs](plugins/dev-workflows/docs/README.md) |
