...
- [`/prd-ground`](prd-ground.md) — the optional, ungated run, on either route, whose `[CG#n]`/`[DG#n]` findings and derivation matrix this command reads and marks `consumed_by: specification` wherever the resolved folder holds them.
