...
- NEVER raise a BLOCKER on a claim that carries a valid `<!-- intentional-discrepancy ... -->` marker — it is a user-acknowledged gap (see `${CLAUDE_PLUGIN_ROOT}/references/source-truth.md` §7.6). Note it as a recorded gap instead.
