...
- **Repo candidates come from `grounding/baselines.md`** — the repositories `/prd-ground` already pinned — rather than from PRD themes and PR URLs, which this route has none of. The soft gate for an unmounted repo is unchanged.
