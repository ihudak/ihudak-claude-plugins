...
- **Automatic.** The end-of-run maintenance phase of all nine workflow commands
  (`/implement`, `/document`, `/epics`, `/vuln`, `/upgrade`, `/release-notes`,
  `/specify`, `/design`, `/idea`) projects the plugin-facing slice of the
...
- **Terminal cost phase** on the seven VI-lifecycle commands (`/idea`, `/specify`, `/epics`,
