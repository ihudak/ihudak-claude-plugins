...
```
/create-prd <JIRA-KEY|BRD-KEY> [@idea.md] [--from-prd <PRD-KEY|path>] [the BRD route [<dir>]] [--lean|--hybrid|--full] [--no-docs] [--no-prior-art]
```
