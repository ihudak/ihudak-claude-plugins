...
/design              → [require-on-main: specification.md] → [code-scanner×N (parallel, cap 4, STRICT gate)] → (embedded grilling, challenges spec) → [design-reviewer@Opus] → write design.md → [handoff-to-main: design.md] → impl-maintenance → commit-artifacts
