...
| `guideline-reviewer` | per routing | Read, Glob, Grep, Bash | Reviews app code and UI against the Experience Standards — AppHeader, DataTable, permissions, accessibility/WCAG, terminology, Grail naming. | `/guideline-reviewer` |
