...
- `references/ard-resolution.md` — most-specific-first ARD resolution (per-area → Epic-level → inherited VI-level) consumed by `/design`, `/implement`, `/specify`, `/epics`, and `/ready`
