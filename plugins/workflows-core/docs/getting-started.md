...
This plugin ships nothing yet — it is an empty, registered skeleton created ahead of the content it will carry, as the first step of the second increment of the `dev-workflows` marketplace split. It reads no environment variables and installs cleanly with nothing further to configure.
