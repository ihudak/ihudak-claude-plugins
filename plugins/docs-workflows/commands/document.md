...
The PRD folder holds a `prd.md` here: Phase 0 step 1's `DOCUMENT_NO_PRD` has already stopped a run whose PRD folder holds none. Store the handoff for downstream phases.
