...
- **Produces:** `idea.md` in `$VAULT_PATH` before an address is chosen, then **prd.md** written to the PRD folder under `$SPECS_PATH/specifications/`; an early release-notes draft.
