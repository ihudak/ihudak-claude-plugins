...
- **Automatic.** The end-of-run maintenance phase of all ten workflow commands
  (`/implement`, `/document`, `/epics`, `/vuln`, `/upgrade`, `/release-notes`,
  `/specify`, `/design`, `/idea`, `/create-vi`) projects the plugin-facing slice of the
...
- **Terminal cost phase** on the eight VI-lifecycle commands (`/idea`, `/create-vi`, `/specify`, `/epics`,
